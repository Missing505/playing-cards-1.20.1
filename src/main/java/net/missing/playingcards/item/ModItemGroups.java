    ...
    public static final ItemGroup PLAYINGCARDS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.playingcards"))
                    .icon(() -> new ItemStack(ModItems.ACE_OF_SPADES)).entries(((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.JACK_OF_SPADES);
                        entries.add(ModItems.QUEEN_OF_SPADES);
                        entries.add(ModItems.KING_OF_SPADES);
                        ...
                        entries.add(ModItems.SEVEN_OF_CLUBS);
                        entries.add(ModItems.EIGHT_OF_CLUBS);
                        entries.add(ModItems.NINE_OF_CLUBS);
                        entries.add(ModItems.TEN_OF_CLUBS);
                        entries.add(ModItems.JACK_OF_CLUBS);
                        entries.add(ModItems.QUEEN_OF_CLUBS);
                        entries.add(ModItems.KING_OF_CLUBS);
                        ...
                        entries.add(ModItems.SEVEN_OF_DIAMONDS);
                        entries.add(ModItems.EIGHT_OF_DIAMONDS);
                        entries.add(ModItems.NINE_OF_DIAMONDS);
                        entries.add(ModItems.TEN_OF_DIAMONDS);
                        entries.add(ModItems.JACK_OF_DIAMONDS);
                        entries.add(ModItems.QUEEN_OF_DIAMONDS);
                        entries.add(ModItems.KING_OF_DIAMONDS);
                        ...
                        entries.add(ModItems.SEVEN_OF_HEARTS);
                        entries.add(ModItems.EIGHT_OF_HEARTS);
                        entries.add(ModItems.NINE_OF_HEARTS);
                        entries.add(ModItems.TEN_OF_HEARTS);
                        entries.add(ModItems.JACK_OF_HEARTS);
                        entries.add(ModItems.QUEEN_OF_HEARTS);
                        entries.add(ModItems.KING_OF_HEARTS);
